...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_ROOT}/DigiMeFramework/DigiMeFramework/Assets/apiCert1.der"
  install_resource "${PODS_ROOT}/DigiMeFramework/DigiMeFramework/Assets/apiCert2.der"
  install_resource "${PODS_ROOT}/DigiMeFramework/DigiMeFramework/Assets/apiCert3.der"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/DigiMeFramework/DigiMeFramework.bundle"
